...
// Recharts globals (UMD exposes window.Recharts)
const { BarChart, Bar, LineChart, Line, XAxis, YAxis, Tooltip, ResponsiveContainer, RadarChart, Radar, PolarGrid, PolarAngleAxis, PolarRadiusAxis, PieChart, Pie, Cell, Area, AreaChart, CartesianGrid } = Recharts;

// Lucide globals (UMD exposes window.LucideReact)
const { Shield, LayoutDashboard, FolderKanban, Link2, Bell, FileCheck, Settings, ChevronRight, TrendingUp, TrendingDown, AlertTriangle, CheckCircle, XCircle, Search, Filter, ChevronDown, ArrowUpRight, Clock, Users, GitBranch, Eye, Zap, BarChart3, Activity, Lock, Unlock, ExternalLink, RefreshCw, Plus, MoreHorizontal } = LucideReact;
...
const StatusDot = ({ active }) => (
  <div style={{ width: 8, height: 8, borderRadius: "50%", background: active ? "var(--green)" : "rgba(245,199,39,0.22)", boxShadow: active ? "0 0 8px var(--green)" : "0 0 6px rgba(245,199,39,0.12)", flexShrink: 0 }} />
);
